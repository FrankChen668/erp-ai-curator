...
- [Project-wide Calibration](PROJECT_CALIBRATION_20260830.md) — 本轮全面盘点、对抗性修正与整改记录。
...
- 产品确实从真实来源问题开始；
- Curator 能形成可审查的采用建议；
- 运行时是否出现明显 over/under-tooling、证据错标或边界偏航。
...
只有任务需要时再读 Skill、Real User Use Validation、AI Leverage、Adversarial Review 或历史材料。
