...
- **找实践**：别人已经有哪些值得学的 AI 实战、教程、工作流或案例？
- **做能力选择**：当前 AI/Agent 已经够不够？是否真的值得再加 Tool / Skill / MCP / 新工作流？

0.9.0 开始，这两件事由两个单职责 Runtime Skill 承担，避免“找最佳实践”自动变成“推荐安装 Skill”。
...
两者整体导入。0.9.0 仍处于受控试用阶段，不声明所有 Agent Skills 宿主都已验证兼容。
...
5. 如果只能看一个，先看哪个；
6. 作者自实践、营销、版本、语言/生态差异、权限或 coverage gap 等重要边界。
...
自然反馈最有价值，例如：推荐资源是不是你真正想看的、是否少搜了很多东西、是否推荐了多余工具、是否漏掉真实环境/权限/版本约束、下次是否还愿意继续用。
